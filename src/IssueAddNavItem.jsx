...
<NavItem onClick={this.showModal}>
  <Glyphicon glyph="plus" /> Создать задачу
  ...
  <Modal.Footer>
    <ButtonToolbar>
      <Button type="button" bsStyle="primary" onClick={this.submit}>Создать</Button>
      <Button bsStyle="link" onClick={this.hideModal}>Отмена</Button>
    </ButtonToolbar>
  </Modal.Footer>
  </Modal>
  <Toast
